...
# Sobrescreve a URL do banco usando Settings
...
def do_run_migrations(connection):
    """
    Executa migrations usando uma conexão síncrona
    fornecida pelo run_sync().
    """
...
async def run_async_migrations():
    """
    Cria engine assíncrona e executa migrations.
    """
